package jp.ac.it_college.std.s25005.kotlin.book.manager.presentation.aop
...
@Component
class LoggingAdvice {
    @Before("execution(* jp.ac.it_college.std.s25000.kotlin.book.manager.presentation.controller.*.*(..))")
    ...
    @After("execution(* jp.ac.it_college.std.s25000.kotlin.book.manager.presentation.controller.*.*(..))")
